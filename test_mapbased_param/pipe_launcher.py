...
def grabargs():
    ...
    parser.add_argument("--dust_marginalization", type=bool, help = "marginalization of the cosmo likelihood over a dust template", default=False)
    parser.add_argument("--sync_marginalization", type=bool, help = "marginalization of the cosmo likelihood over a sync template", default=False)
