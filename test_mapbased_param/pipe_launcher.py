...
\n")
    ...
    if rank ==0 :
        ...
        if args.AL_marginalization:
            ...
            # frame.set_edgecolor('white')
            # legend.get_frame().set_alpha(0.3)
            ax[1,0].xlabel(r'$A_{\rm lens}$', fontsize=16)
            ax[1,0].ylabel('number of simulations', fontsize=16)
            ax[1,1].xlabel(r'$A_{\rm lens}$', fontsize=16)
            ax[1,1].ylabel('number of simulations', fontsize=16)
