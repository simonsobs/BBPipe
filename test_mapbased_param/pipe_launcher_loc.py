...
BBClEstimation:
    ...
    apotype:  '''+str(apotype)+'''
    purify_b: True
    Cls_fiducial: '/Users/josquin1/Documents/Dropbox/CNRS-CR2/Simons_Observatory/SO_SAT_forecasting_tool/templates/Cls_Planck2018_lensed_scalar.fits'
...
def main():
    ...
    for sim in simulations_split[rank]:
        ...
        # submit call 
        # time.sleep(10*rank)
        print("subprocess call = ", "bbpipe ", os.path.join(args.path_to_temp_files, "test_"+id_tag+".yml"))
        ...
        p = os.system("bbpipe "+os.path.join(args.path_to_temp_files, "test_"+id_tag+".yml"))
