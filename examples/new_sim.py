...
if len(sys.argv) != 4:
    print("Usage: pysm_componentspip2_temp.py seed simulate nside")
    exit(1)
seed = int(sys.argv[1])
...
# Dust
dl_dust_bb = A_dust_BB * ((ells+0.00000000000001) / 80.)**alpha_dust_BB # + 0.00000000000001 added to avoid divide by zero 
